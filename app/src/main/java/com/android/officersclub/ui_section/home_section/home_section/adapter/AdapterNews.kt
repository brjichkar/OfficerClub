...
class AdapterNews (private var historyList: MutableList<NewsModel>, private var mContext: Context) : androidx.recyclerview.widget.RecyclerView.Adapter<AdapterNews.NewsItemAdapter>()
{
    /**
    ...
    inner class NewsItemAdapter(itemView: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(itemView){
        fun setDataToView(sampleDataModel: NewsModel, receivedContext: Context){
