package com.officersclub.ui_section.home_section.home_section
...
import com.officersclub.ui_section.home_section.home_section.adapter.AdapterGallery
...
import com.officersclub.ui_section.home_section.home_section.adapter.AdapterFacilities
import com.officersclub.ui_section.home_section.home_section.adapter.AdapterVideos
...
import com.officersclub.ui_section.home_section.profile_section.membership_section.ActivityMembership
...
import com.officersclub.ui_section.profile_section.mvp.ProfileMVP
import com.officersclub.ui_section.profile_section.mvp.ProfilePresenterImplementer
...
class FragmentHome : BaseFragment(),HomeMVP.HomeView, ProfileMVP.ProfileView {
    ...
    private var mGalleryList: MutableList<com.officersclub.ui_section.home_section.home_section.model.gallery.DataX> = mutableListOf()
    private var mFacilitiesList: MutableList<DataX> = mutableListOf()
    private var mVideoList: MutableList<com.officersclub.ui_section.home_section.home_section.model.videos.DataX> = mutableListOf()
    ...
    override fun onMembershipSuccess(tempResponse: com.officersclub.ui_section.home_section.home_section.model.membership.DataX) {
    ...
    override fun onProfileImageUploadSuccess(tempResponse: com.officersclub.ui_section.profile_section.model.photo.Data) {
