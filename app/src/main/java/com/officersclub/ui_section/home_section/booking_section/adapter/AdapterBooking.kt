package com.officersclub.ui_section.home_section.booking_section.adapter
...
import com.officersclub.ui_section.home_section.booking_section.details.ActivityServiceDetails
...
class AdapterBooking (private var historyList:
                      MutableList<com.officersclub.ui_section.home_section.booking_section.model.services.DataX>, private var mContext: Context) : androidx.recyclerview.widget.RecyclerView.Adapter<AdapterBooking.HistoryItemAdapter>()
{
    /**
    ...
    inner class HistoryItemAdapter(itemView: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(itemView){
        fun setDataToView(sampleDataModel: com.officersclub.ui_section.home_section.booking_section.model.services.DataX, receivedContext: Context){
