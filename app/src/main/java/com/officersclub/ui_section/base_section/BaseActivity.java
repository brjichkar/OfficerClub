...
import com.officersclub.ui_section.utility_section.CommonUtils;
import com.officersclub.ui_section.utility_section.NetworkUtils;
...
public abstract class BaseActivity extends AppCompatActivity implements MvpView, BaseFragment.Callback{
    ...
    protected void nothingToDisplay() {
     ...
     *  @params   : void
     *  @Return   : void
     * 	@Usage	  : Used to get the image file path while choosing profile picture from gallery (Support method for Profile Edit Page)
     *  @Author   : 1769
     */
    @SuppressLint("NewApi")
